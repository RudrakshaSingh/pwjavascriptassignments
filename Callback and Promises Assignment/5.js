...
// a greeting message. The function should greet the person using their name, with a message in 
// the format "Hello, {name}!".For example, if the input to the function is "Mithun", the promise 
